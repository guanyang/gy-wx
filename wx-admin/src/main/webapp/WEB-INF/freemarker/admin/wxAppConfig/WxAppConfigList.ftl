...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>微信通用配置报表</title>
  </head>
  <body> 
	<div id="searchPanel" class="easyui-panel" title="微信通用配置报表"
		...
		<div class="grid-toolbar">
			<form id="searchFrm">
				<table class="tblContent" style="width:100%;">
							<tr>
								<td class="tdLeft"><span>APPID:</span></td>
								<td class="tdRight"><input id="appId" name="appId"/></td>
								<td class="tdLeft"><span>APPSECRET:</span></td>
								<td class="tdRight"><input id="appSecret" name="appSecret"/></td>
								<td class="tdLeft"><span>公众号名称:</span></td>
								<td class="tdRight"><input id="appName" name="appName"/></td>
								<td class="tdLeft"><span>是否启用:</span></td>
								<td class="tdRight">
	    ...
	    <div id="addDialog" class="easyui-dialog" iconCls="icon-add"
         style="width: auto; height: auto;" closed="true" modal="true"
        ...
        <form id="addForm" method="post">
            <table class="formbox" border="0" cellpadding="5px" cellspacing="5px" style="width:100%">
							<input type="hidden" id="idAdd" name="id" />
								<tr>
									<td style="text-align:right;width:20%"><span style="color:red">*</span>APPID：</td>
									<td>
									<input class="easyui-validatebox" required="true" data-options="validType:'length[1,64]'" id="appIdAdd" name="appId"  type="text" />
									</td>
								</tr>
								<tr>	
									<td style="text-align:right;width:20%"><span style="color:red">*</span>APPSECRET：</td>
									<td>
									<input class="easyui-validatebox" required="true" data-options="validType:'length[1,64]'" id="appSecretAdd" name="appSecret"  type="text" />
									</td>
								</tr>
								<tr>
									<td style="text-align:right;width:20%"><span style="color:red">*</span>公众号名称：</td>
									<td>
									<input class="easyui-validatebox" required="true" data-options="validType:'length[1,32]'" id="appNameAdd" name="appName"  type="text" />
									</td>
								</tr>
								<tr>	
									<td style="text-align:right;width:20%"><span style="color:red">*</span>验证令牌：</td>
									<td>
									<input class="easyui-validatebox" required="true" data-options="validType:'length[1,128]'" id="validateTokenAdd" name="validateToken"  type="text" />
									</td>
								</tr>
								<tr>	
									<td style="text-align:right;width:20%"><span style="color:red">*</span>是否启用：</td>
									<td>
									<select class="easyui-combobox" required="true" id="enableAdd" name="enable" style="width:100px;" panelHeight="auto" editable="false">
			                            <option value="1">启用</option>
			                            <option value="2">禁用</option>
			                        </select>
									</td>
	...
	<!--引入js路径-->
	<@resMacro.jsurl resRoot="${javascriptServerAdmin}" url=["/js/wxAppConfig/WxAppConfigList"] resConcat="${resConcat}" />
  </body>
</html>
