var url = "${adminServer}/weixinReplyLog/query.htm";
var saveUrl = "${adminServer}/weixinReplyLog/save.htm";
var getUrl = "${adminServer}/weixinReplyLog/get.htm";
var deleteUrl = "${adminServer}/weixinReplyLog/delete.htm";
tdSize();// 必须放在外面
